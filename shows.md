  ...
  <tr data-bw="{{ has_bw_icon }}">
    ...
    <td style="padding: 0.5rem 0.8rem 0.65rem 0; vertical-align: top;">
      ...
      <div style="font-size: 12px; margin-top: 0.25rem; line-height: 1.4;">
        {% if show.subtitle and show.subtitle != '' %}<span style="font-style: italic;">{{ show.subtitle }}</span>{% endif %}
        {% if show.subtitle and show.subtitle != '' and show.venue and show.venue != '' %} &nbsp;|&nbsp; {% endif %}
        {% if show.venue and show.venue != '' %}{{ show.venue }}{% endif %}
        {% if show.kind and show.kind != '' %}
          {% if (show.subtitle and show.subtitle != '') or (show.venue and show.venue != '') %} &nbsp;|&nbsp; {% endif %}
